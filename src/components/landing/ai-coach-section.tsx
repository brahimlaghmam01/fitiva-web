...
import { Brain, Bell, LineChart, Sparkles, Clock } from "lucide-react";
...
export function AICoachSection() {
  ...
  const features = [
    { icon: Brain, titleKey: "ai.personalizedWorkouts", descKey: "ai.personalizedWorkoutsDesc" },
    { icon: Sparkles, titleKey: "ai.smartSuggestions", descKey: "ai.smartSuggestionsDesc" },
    { icon: Bell, titleKey: "ai.progressTracking", descKey: "ai.progressTrackingDesc" },
    { icon: LineChart, titleKey: "ai.adaptivePlans", descKey: "ai.adaptivePlansDesc" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative bg-card rounded-3xl border border-border p-6 lg:p-8 shadow-2xl">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-green-400 flex items-center justify-center shadow-lg">
              ...
              <div className="space-y-4">
                ...
                >
                  <p className="text-sm text-foreground">Sounds good! What do you suggest?</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-primary/10 rounded-2xl rounded-tl-none p-4"
                >
                  <p className="text-sm text-foreground mb-3">Here's your personalized plan:</p>
              ...
              >
                ...
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-green-400 flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity shadow-md">
          ...
          >
            ...
            >
              ...
              <motion.h2 variants={staggerItem} className="text-3xl sm:text-4xl lg:text-5xl font-bold text-balance mb-6">
                Your personal <span className="text-primary">AI fitness coach</span>
              </motion.h2>
              <motion.p variants={staggerItem} className="text-lg text-muted-foreground mb-8 text-pretty">
                {t("ai.subtitle")}
              </motion.p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="flex items-start gap-4 card-hover p-4 rounded-2xl hover:bg-card"
                >
